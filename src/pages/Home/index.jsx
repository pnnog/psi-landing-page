    ...
    <>
      ...
      <SectionModel id='aviso' background='gray'>
        <p className={paragraph({size:'sm'})}>
          <strong>ATENÇÃO</strong>: Este site não oferece tratamento ou aconselhamento imediato para pessoas em crise suicida. Em caso de crise, ligue para 188 (CVV) ou acesse o site <a href="https://www.cvv.org.br" target="_blank" className="text-psi-purple-200">www.cvv.org.br</a>. Em caso de emergência, procure atendimento em um hospital mais próximo. 
        </p>
      </SectionModel>
